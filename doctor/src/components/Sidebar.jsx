          ...
          <div className='w-[20vw] relative'>
               ...
               <header className='flex items-center justify-center p-2 w-full h-20 group relative cursor-pointer mt-3' >
                    <div className='flex items-center gap-3 group-hover:bg-zinc-800 rounded-xl p-2 w-full'>
                         ...
                         <NavLink className='flex justify-between items-center w-[80%]' to={'/profile'} >
                              <div className='flex flex-col px-3'>

                                   <p className=' text-[16px] font-medium'>Doctor Panel</p>
                                   <p className='text-[14px] opacity-[.56]'>chopper123@gmail.com</p>
                              </div>
               ...
               {/* patient section */}
               <section className='w-full px-2 py-2 flex-col flex gap-3 relative '>
                    <p className='text-sm opacity-[.56] px-2'>manage patients</p>
                    ...
                    <NavLink to={'/beds'} className={({isActive})=> isActive? 'w-full flex items-center gap-3 rounded-xl px-2 py-3 hover:bg-zinc-800 cursor-pointer text-[#BC37F5]' :'w-full flex items-center gap-3 rounded-xl px-2 py-3 hover:bg-zinc-800 cursor-pointer text-zinc-200'}>
                         <BedSingle className='w-6 h-6' />
                         <span className='font-medium'>see beds</span>
                    </NavLink>
