...
const Bed = ({ ward, bedNumber, patientName, available, gender, patientId }) => {
     return (
          <div className={`bg-gradient-to-b ${available ? 'from-[#49197D] to-[#49197d5b]' : "from-[#27272A] to-[#27272a76]"} h-28 w-[75%] mx-auto rounded-2xl flex-col flex justify-evenly relative group cursor-pointer`}>
