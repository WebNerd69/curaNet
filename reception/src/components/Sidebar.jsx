     ...
     return (
          <div className='w-[20vw] relative'>
               ...
               <section className='w-full px-2 py-2 flex-col flex gap-3 relative '>
                    ...
                    <p className='text-sm opacity-[.56] px-2'>patients</p>

                    <NavLink to={'/patients'} end className={({isActive})=> isActive? 'w-full flex items-center gap-3 rounded-xl px-2 py-3 hover:bg-zinc-800 cursor-pointer text-[#BC37F5]' :'w-full flex items-center gap-3 rounded-xl px-2 py-3 hover:bg-zinc-800 cursor-pointer text-zinc-200'}>
                         <UsersRound className='w-6 h-6' />
                         <span className='font-medium'>See Patients</span>
                    </NavLink>

                    <NavLink to={'/patients/add'} className={({isActive})=> isActive? 'w-full flex items-center gap-3 rounded-xl px-2 py-3 hover:bg-zinc-800 cursor-pointer text-[#BC37F5]' :'w-full flex items-center gap-3 rounded-xl px-2 py-3 hover:bg-zinc-800 cursor-pointer text-zinc-200'}>
               ...
               <section className='w-full px-2 py-2 flex-col flex gap-3 relative '>
                    ...
                    <NavLink to={'/appointments'} end className={({isActive})=> isActive? 'w-full flex items-center gap-3 rounded-xl px-2 py-3 hover:bg-zinc-800 cursor-pointer text-[#BC37F5]' :'w-full flex items-center gap-3 rounded-xl px-2 py-3 hover:bg-zinc-800 cursor-pointer text-zinc-200'}>
                         <BedSingle className='w-6 h-6' />
                         <span className='font-medium'>See Appointments</span>
                    </NavLink>

                    <NavLink to={'/appointments/book'} className={({isActive})=> isActive? 'w-full flex items-center gap-3 rounded-xl px-2 py-3 hover:bg-zinc-800 cursor-pointer text-[#BC37F5]' :'w-full flex items-center gap-3 rounded-xl px-2 py-3 hover:bg-zinc-800 cursor-pointer text-zinc-200'}>
                         <BedSingle className='w-6 h-6' />
                         <span className='font-medium'>Book Appointment</span>
                    </NavLink>

                    <NavLink to={'/appointments/reschedule'} className={({isActive})=> isActive? 'w-full flex items-center gap-3 rounded-xl px-2 py-3 hover:bg-zinc-800 cursor-pointer text-[#BC37F5]' :'w-full flex items-center gap-3 rounded-xl px-2 py-3 hover:bg-zinc-800 cursor-pointer text-zinc-200'}>
                         <BedSingle className='w-6 h-6' />
                         <span className='font-medium'>Reschedule Appointment</span>
                    </NavLink>

                    <NavLink to={'/appointments/cancel'} className={({isActive})=> isActive? 'w-full flex items-center gap-3 rounded-xl px-2 py-3 hover:bg-zinc-800 cursor-pointer text-[#BC37F5]' :'w-full flex items-center gap-3 rounded-xl px-2 py-3 hover:bg-zinc-800 cursor-pointer text-zinc-200'}>
                         <BedSingle className='w-6 h-6' />
