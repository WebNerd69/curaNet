...
const Sidebar = () => {
     ...
     return (
          <div className='w-[100vw] md:w-[20vw] -translate-x-full md:translate-x-0 relative h-full'  id='sidebar'>
               ...
               <div className='bg-zinc-900 h-screen text-zinc-200 md:w-[20vw] w-[100vw] flex flex-col gap-5 fixed top-0 left-0 z-10'>
                    ...
                    <header className='flex items-center justify-center p-2 w-full h-20 group relative cursor-pointer md:mt-3' >
                         <div className='flex items-center gap-3 md:group-hover:bg-zinc-800 rounded-xl p-2 w-full'>
                              <div className={`absolute w-60 h-48 rounded-xl bg-zinc-800 border-1 border-zinc-700 top-3 right-0 md:left-[18vw] flex flex-col justify-center items-center p-2 gap-1  ${isOpen ? "opacity-100 z-10 block" : "opacity-0 z-0 hidden"} transition-opacity duration-150 shadow-xl`}>
                              ...
                              <div className='flex justify-between items-center md:w-[80%] w-full' onClick={popUpHandler}>
                                   <div className='flex flex-col px-3'>
                                        ...
                                        <p className=' text-[16px] font-medium'>Rudra Pratap Roy</p>
                                        <p className='text-[14px] opacity-[.56]'>lol123@gmail.com</p>
                                   </div>
                    ...
                    <section className='w-full px-5 py-2 flex-col flex gap-3 relative '>
                         ...
                         <NavLink to={'/prescriptions'} className={({ isActive }) => isActive ? 'w-full flex items-center gap-3 rounded-xl px-2 py-3 md:hover:bg-zinc-800 cursor-pointer text-[#BC37F5]' : 'w-full flex items-center gap-3 rounded-xl px-2 py-3 md:hover:bg-zinc-800 cursor-pointer text-zinc-200'}>
                              <NotepadText className='w-6 h-6' />
                              <span className='font-medium'>prescriptions</span>
                         </NavLink>
                         <NavLink to={'/reports'} className={({ isActive }) => isActive ? 'w-full flex items-center gap-3 rounded-xl px-2 py-3 md:hover:bg-zinc-800 cursor-pointer text-[#BC37F5]' : 'w-full flex items-center gap-3 rounded-xl px-2 py-3 md:hover:bg-zinc-800 cursor-pointer text-zinc-200'}>
                              <Notebook className='w-6 h-6' />
                              <span className='font-medium'>reports</span>
                         </NavLink>
                         <NavLink to={'/payments'} className={({ isActive }) => isActive ? 'w-full flex items-center gap-3 rounded-xl px-2 py-3 md:hover:bg-zinc-800 cursor-pointer text-[#BC37F5]' : 'w-full flex items-center gap-3 rounded-xl px-2 py-3 md:hover:bg-zinc-800 cursor-pointer text-zinc-200'}>
                              <Notebook className='w-6 h-6' />
